...
export default function OrderCreate() {
  ...
  const formattedRx = {
    ...newRx,
    rightSph: Number(newRx.rightSph || 0),
    rightCyl: Number(newRx.rightCyl || 0),
    rightAxis: Number(newRx.rightAxis || 0),
    rightAdd: Number(newRx.rightAdd || 0),
    leftSph: Number(newRx.leftSph || 0),
    leftCyl: Number(newRx.leftCyl || 0),
    leftAxis: Number(newRx.leftAxis || 0),
    leftAdd: Number(newRx.leftAdd || 0),
    pd: Number(newRx.pd || 0),
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (!useExistingRx && hasPrescription) {
